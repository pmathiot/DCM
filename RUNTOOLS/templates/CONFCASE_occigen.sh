...
if [ $DCMVERSION != '4.0.3_TIPACCS' ] ; then echo 'Module DCM/4.0.3_TIPACCS not loaded; exit 1'; exit 1; fi
...
export NB_NPROC=1138    # number of cores used for NEMO
export NB_NPROC_IOS=14  # number of cores used for xios (number of xios_server.exe)
...
export NB_NPROC_MER=24  # number of cores used for rebuild on the fly  (1/node is a good choice)
