...
CONTAINS
...
#if defined key_tipaccs
         CALL gammats_vel_stab (Kmm, pttbl, pstbl, zutbl, zvtbl, rCd0_top, rke0_top , pqoce, pqfwf, pRc, pgt, pgs )
#else
...
#if defined key_tipaccs
         zustar(ji,jj) = SQRT( pCd(ji,jj) * ( putbl(ji,jj) * putbl(ji,jj) + pvtbl(ji,jj) * pvtbl(ji,jj) + pke2(ji,jj) ) ) * mskisf_cav(ji,jj)
#else
   ...
   SUBROUTINE gammats_vel_stab( Kmm, pttbl, pstbl, putbl, pvtbl, pCd, pke2, pqoce, pqfwf, pRc, &  ! <<== in
      ...
      DO_2D( nn_hls, nn_hls, nn_hls, nn_hls )
         ...
         ! compute ustar
#if defined key_tipaccs
         zustar(ji,jj) = SQRT( pCd(ji,jj) * ( putbl(ji,jj) * putbl(ji,jj) + pvtbl(ji,jj) * pvtbl(ji,jj) + pke2(ji,jj) ) )
#else
